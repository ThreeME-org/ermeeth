...
#' @param calib_baseline Name of the calibrated data for the baseline. Default is the ermeeth data name "OGcalib"
#' @param calib_shock Name of the calibrated data after integrating the baseline scenario changes. Default is the ermeeth data name "calib_new_base"
#'
