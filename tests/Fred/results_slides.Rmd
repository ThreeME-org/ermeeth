...
A <- curve_sc_plot(data_sector,"EMS_X", startyear = startyear, endyear = endyear, group_type = "C", growth.rate = FALSE,diff = TRUE,abs.diff = FALSE, title = "GHG emissions per source (in difference from baseline)")

data_plot <- contrib.sub(data_sector,var1 =  "EMS_X",
group_type = "C", scenar = c("baseline", scenario_name))
