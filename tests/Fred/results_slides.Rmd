...
#A <- simpleplot(new_indicators,c(c("EMS"),contrib_comp), c(c("Total GHG emssions |   Related to ..."),contrib_comp_label), startyear, endyear, titleplot = "GHG emissions and its components (in difference from baseline)")

A <- simpleplot(new_indicators,contrib_comp, contrib_comp_label, startyear, endyear, titleplot = "GHG emissions and its components (in difference from baseline)")
