...
A <- curve_sc_plot(data_sector,"EMS_CI", group_type = "commodity", growth.rate = FALSE,diff = TRUE,abs.diff = FALSE, title = "GHG emissions per source (in difference from baseline)")

data_plot <- contrib.sub(data_sector,var1 =  "EMS_CI",
group_type = "commodity", scenar = c("baseline", scenario_name))
