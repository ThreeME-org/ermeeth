...
data_fig$facet_by <- factor(data_fig$facet_by,      # Reordering group factor levels
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_VAL_FL_Y", years = 2019, title = "", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_VAL_FK_Y", years = 2019, title = "Cost share of capital by sectors", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_VAL_FE_Y", years = 2019, title = "Cost share of energy by sectors", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_VAL_FMAT_Y", years = 2019, title = "Cost share of material by sectors", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_VAL_VA_Y", years = 2019, title = "Share of value added into the production by sectors", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_VAL_L_VA", years = 2019, title = "Labor share into the value added by sectors", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_VAL_PI_VA", years = 2019, title = "Profits share into the value added by sectors", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_MGS_GDP", years = 2019, title = "Margins share into GDP by commodities", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_CI_GDP", years = 2019, title = "Intermediary consumption share into GDP by commodities", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_FE_S_GDP", years = 2019, title = "Energy share into GDP by sector", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_CH_GDP", years = 2019, title = "Household's consumption share into GDP by commodities", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_G_GDP", years = 2019, title = "Gouvernement expenditure share into GDP by commodities", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_I_GDP", years = 2019, title = "Investment share into GDP by commodities", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_X_GDP", years = 2019, title = "Export share into GDP by commodities", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_M_GDP", years = 2019, title = "Import share into GDP by commodities", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "BLC_TRADE", years = 2019, title = "Trade balance by commodities", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "OPN_TRADE", years = 2019, title = "Trade openness by commodities", scenario = "baseline")
