...
```{r Add short names for Bridge - c_23_s_26, eval=FALSE, include=FALSE}
...
```{r Add short names for Bridge - c_28_s_32}

short_names_c <- c("Agriculture","Forestry","Food","Vehicles","Non-metallic minerals",
                   "Paper","Chemicals","Plastics","Metals","Other industries","Other consumers",
                   "Construction","Rail","Road","Water","Air","Business","Public",
                   "Non-energy mining","Coal","Oil","Transport fuels","Heating fuel","Natural gas",
                   "Electricity","Heat","Biomass","Other energy",
                   "TOTAL.1","TOTAL.2","TOTAL.3","TOTAL.4","TOTAL.5","TOTAL.6","TOTAL.7","TOTAL.8")

names_commodities <- names_commodities %>% cbind(short_names_c) %>% purrr::set_names(c("name","code","short_name"))

short_names_s <- c("Agriculture","Forestry","Food","Vehicles","Non-metallic minerals",
                   "Paper","Chemicals","Plastics","Metallurgy","Other industries","Other consumers",
                   "Construction","Rail","Road","Water","Air","Business","Public",
                   "Mining","Refined oil","Biofuel","Natural gas","Biogas","Nuclear elec.",
                   "Oil elec.","Gas elec.","Coal elec.","Wind elec.","Solar elec.","Hydro elec.","CHP elec.",
                   "Other elec.","TOTAL.1","TOTAL.2","TOTAL.3","TOTAL.4","TOTAL.5","TOTAL.6","TOTAL.7","TOTAL.8")
...
data_ratio <- rbind(dplyr::filter(data_full,variable %in% variables_selection),
  ...
  list_S_variable <- c("F_L","F_K","F_MAT","F_E","C_L","C_K","C_MAT","C_E","I","Y","PY","EMS_CI","VA","VA_VAL") %>%
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_FL_Y", years = c(2019,2050), title = "F_L[s] / Y[s]", scenario = scenario_name)
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_FK_Y", years = c(2019,2050), title = "F_K[s] / Y[s]", scenario = scenario_name)
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_FE_Y", years = c(2019,2050), title = "F_E[s] / Y[s]", scenario = scenario_name)
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_FMAT_Y", years = c(2019,2050), title = "F_MAT[s] / Y[s]", scenario = scenario_name)
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_I_Y", years = c(2019,2050), title = "I[s] / Y[s]", scenario = scenario_name)
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_VAL_FL_Y", years = c(2019,2050), title = "(C_L[s] * F_L[s]) / (PY[s] * Y[s])", scenario = scenario_name)
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_VAL_FK_Y", years = c(2019,2050), title = "(C_K[s] * F_K[s]) / (PY[s] * Y[s])", scenario = scenario_name)
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_VAL_FE_Y", years = c(2019,2050), title = "(C_E[s] * F_E[s]) / (PY[s] * Y[s])", scenario = scenario_name)
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_VAL_FMAT_Y", years = c(2019,2050), title = "(C_MAT[s] * F_MAT[s]) / (PY[s] * Y[s])", scenario = scenario_name)
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_VAL_VA_Y", years = c(2019,2050), title = "VA_VAL[s] / (PY[s]*Y[s])", scenario = scenario_name)
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_VAL_L_VA", years = c(2019,2050), title = "(C_L[s] * F_L[s]) / VA_VAL[s]", scenario = scenario_name)
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_VAL_PI_VA", years = c(2019,2050), title = "1 - [ (C_L[s] * F_L[s]) / VA_VAL[s] ]", scenario = scenario_name)
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_MGS_GDP", years = c(2019,2050), title = "MGS[c] / GDP", scenario = scenario_name)
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_CI_GDP", years = c(2019,2050), title = "CI[c] / GDP", scenario = scenario_name)
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_FE_S_GDP", years = c(2019,2050), title = "F_E[s] / GDP", scenario = scenario_name)
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_CH_GDP", years = c(2019,2050), title = "CH[c] / GDP", scenario = scenario_name)
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_G_GDP", years = c(2019,2050), title = "G[c] / GDP", scenario = scenario_name)
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_I_GDP", years = c(2019,2050), title = "I[c] / GDP", scenario = scenario_name)
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_X_GDP", years = c(2019,2050), title = "X[c] / GDP", scenario = scenario_name)
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_M_GDP", years = c(2019,2050), title = "M[c] / GDP", scenario = scenario_name)
...
fig <- plot_ratio(data = data_ratio, indicator = "BLC_TRADE", years = c(2019,2050), title = "( X[c] - M[c] ) / GDP", scenario = scenario_name)
...
fig <- plot_ratio(data = data_ratio, indicator = "OPN_TRADE", years = c(2019,2050), title = "( X[c] + M[c] ) / GDP", scenario = scenario_name)
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_EMS_CH", years = c(2019,2050), title = "EMS_CO2_CH[c] / EMS_CO2_CH", scenario = scenario_name)
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_EMS_CI_C", years = c(2019,2050), title = "EMS_CO2_CI[c] / EMS_CO2_CI", scenario = scenario_name)
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_EMS_CI_S", years = c(2019,2050), title = "EMS_CO2_CI[s] / EMS_CO2_CI", scenario = scenario_name)
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_VA", years = c(2019,2050), title = "VA[s] / VA", scenario = scenario_name)
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_Y", years = c(2019,2050), title = "Y[s] / Y", scenario = scenario_name)
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_GDP", years = c(2019,2050), title = "GDP[c] / GDP", scenario = scenario_name)
