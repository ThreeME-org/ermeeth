...
### Inputs check
  ...
  if(length(years) > 1 ){
    stop("Please choose only one year each time. \n")
...
data_fig$short_name <- factor(data_fig$short_name, levels = data_fig$short_name)

### Plot drawing
fig <- ggplot(data_fig, aes(x = short_name, y = get(scenario), fill = facet_by, group = facet_by)) + 
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_FL_Y", years = 2019, title = "F_L[s] / Y[s]", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_FK_Y", years = 2019, title = "F_K[s] / Y[s]", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_FE_Y", years = 2019, title = "F_E[s] / Y[s]", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_FMAT_Y", years = 2019, title = "F_MAT[s] / Y[s]", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_I_Y", years = 2019, title = "I[s] / Y[s]", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_VAL_FL_Y", years = 2019, title = "(C_L[s] * F_L[s]) / (PY[s] * Y[s])", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_VAL_FK_Y", years = 2019, title = "(C_K[s] * F_K[s]) / (PY[s] * Y[s])", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_VAL_FE_Y", years = 2019, title = "(C_E[s] * F_E[s]) / (PY[s] * Y[s])", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_VAL_FMAT_Y", years = 2019, title = "(C_MAT[s] * F_MAT[s]) / (PY[s] * Y[s])", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_VAL_VA_Y", years = 2019, title = "VA_VAL[s] / (PY[s]*Y[s])", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_VAL_L_VA", years = 2019, title = "(C_L[s] * F_L[s]) / VA_VAL[s]", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_VAL_PI_VA", years = 2019, title = "1 - [ (C_L[s] * F_L[s]) / VA_VAL[s] ]", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_MGS_GDP", years = 2019, title = "MGS[c] / GDP", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_CI_GDP", years = 2019, title = "CI[c] / GDP", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_FE_S_GDP", years = 2019, title = "F_E[s] / GDP", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_CH_GDP", years = 2019, title = "CH[c] / GDP", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_G_GDP", years = 2019, title = "G[c] / GDP", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_I_GDP", years = 2019, title = "I[c] / GDP", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_X_GDP", years = 2019, title = "X[c] / GDP", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_M_GDP", years = 2019, title = "M[c] / GDP", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "BLC_TRADE", years = 2019, title = "( X[c] - M[c] ) / GDP", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "OPN_TRADE", years = 2019, title = "( X[c] + M[c] ) / GDP", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_EMS_CH", years = 2019, title = "EMS_CO2_CH[c] / EMS_CO2_CH", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_EMS_CI_C", years = 2019, title = "EMS_CO2_CI[c] / EMS_CO2_CI", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_EMS_CI_S", years = 2019, title = "EMS_CO2_CI[s] / EMS_CO2_CI", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_VA", years = 2019, title = "VA[s] / VA", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_Y", years = 2019, title = "Y[s] / Y", scenario = "baseline")
...
fig <- plot_ratio(data = data_ratio, indicator = "PHI_GDP", years = 2019, title = "GDP[c] / GDP", scenario = "baseline")
