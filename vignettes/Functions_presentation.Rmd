...
simpleplot(data,c("GDP", "CH", "I", "G"), label_macro, startyear =  2015,endyear =  2030, titleplot = "GDP and its components  (in difference from baseline)")

simpleplot(data,c("RDEBT_G_VAL"),label_series = "Public Debt", startyear = start_year, endyear = end_year, "diff", titleplot = "Public Account (in GDP points, difference from baseline)")
```
...
curve_sc_plot(data,"Y", growth.rate = FALSE,diff = TRUE,abs.diff = FALSE, title = "Production by sector (in difference from baseline)")
